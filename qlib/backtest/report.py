...
class PortfolioMetrics:
    ...
    Implementation:
        ...
        - long_account: the total value of long assets in user account based on the close price of each step.
        - short_account: the total value of short assets in user account based on the close price of each step.
    ...
    def init_vars(self) -> None:
        ...
        self.long_accounts: dict = OrderedDict()  # long account position value for each trade time
        self.short_accounts: dict = OrderedDict()  # short account position value for each trade time
    ...
    def get_latest_short_account_value(self) -> float:
        return self.short_accounts[self.latest_pm_time]

    def update_latest_short_account_value(self, value: float) -> None:
        """Update the latest short account value.

        Parameters
        ----------
        value : float
            The latest short account value.
        """
        self.short_accounts[self.latest_pm_time] = value

    def get_latest_long_account_value(self) -> float:
        return self.long_accounts[self.latest_pm_time]

    def update_latest_long_account_value(self, value: float) -> None:
        """Update the latest long account value.

        Parameters
        ----------
        value : float
            The latest long account value.
        """
        self.long_accounts[self.latest_pm_time] = value
    ...
    def update_portfolio_metrics_record(
        ...
        long_account_value: float | None = None,
        short_account_value: float | None = None,
        ...
        self.long_accounts[trade_start_time] = long_account_value
        self.short_accounts[trade_start_time] = short_account_value
    ...
    def generate_portfolio_metrics_dataframe(self) -> pd.DataFrame:
        ...
        pm["long_account"] = pd.Series(self.long_accounts)
        pm["short_account"] = pd.Series(self.short_accounts)
    ...
    def load_portfolio_metrics(self, path: str) -> None:
        ...
        for trade_start_time in index:
            self.update_portfolio_metrics_record(
                ...
                long_account_value=r.loc[trade_start_time]["long_account"],
                short_account_value=r.loc[trade_start_time]["short_account"],
